  ...
  return (
    <main>
      ...
      <div className="main grid max-w-[900px] grid-cols-1 gap-8 text-balance py-4 text-3xl font-light leading-tight md:text-4xl">
        <p>I&apos;m Jared Rhizor, a bootstrapped founder building <Link href="https://www.elmohq.com/?ref=jrhizor" className="font-normal decoration-neutral-400 hover:underline hover:underline-offset-2">open source AI search optimization</Link>.</p>
